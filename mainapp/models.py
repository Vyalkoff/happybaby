...
class Product(models.Model):
    ...
    price = models.DecimalField(verbose_name='цена продукта', max_digits=6, decimal_places=0)
    old_price = models.DecimalField(verbose_name='старая цена продукта', max_digits=6, decimal_places=0,
                                    blank=True)
